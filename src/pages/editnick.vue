        ...
        <div class="login-box">
            ...
            <div class="item-box">
                <div class="ipt-box">
                        ...
                        <input type="text" v-model="newnick" placeholder="请输入新的昵称" />
            ...
            <div class="bottom-text">
                <div class="left">
                    <!-- <div class="right" @click="$router.push('/reg')">
                        注册
                    </div> -->
                </div>
                <!-- <div class="left">
                    <div class="right" @click="submit($event)">
                        登录
                    </div>
                </div> -->
                <!-- <div class="right">
    ...
    export default{
        ...
        methods: {
            submit(e){
                ...
                let {user}=this
                this.ajax({
                    url:'index/user/update_name',
                    data:{
                        token:token,
                        nick_name:this.newnick
                    }
                }).then(res=>{
